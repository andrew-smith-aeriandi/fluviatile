...
namespace Grid.Tests
{
    public class TableauTests
    {
        ...
        public void Constructor_PopulatesProperties()
        {
            ...
            {
                new TerminalNode(0, new Coordinates(1, -1), new[] { (Hexagon.Azimuth180, nodes[0]) }, aisles[0]),
                new TerminalNode(1, new Coordinates(5, 1), new[] { (Hexagon.Azimuth240, nodes[1]) }, aisles[1]),
                new TerminalNode(2, new Coordinates(7, 5), new[] { (Hexagon.Azimuth300, nodes[2]) }, aisles[2]),
                new TerminalNode(3, new Coordinates(5, 7), new[] { (Hexagon.Azimuth000, nodes[3]) }, aisles[3]),
                new TerminalNode(4, new Coordinates(1, 5), new[] { (Hexagon.Azimuth060, nodes[4]) }, aisles[4]),
                new TerminalNode(5, new Coordinates(-1, 1), new[] { (Hexagon.Azimuth120, nodes[5]) }, aisles[5])
            };
